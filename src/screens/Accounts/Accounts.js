...
import {IconAsset, UiColor, FontFamily, TextSize, Spacing, FontSize} from '../../theme';
  ...
  return(
    <View>
      ...
      />
       ...
       <FlatList
        data={MenuList}
        contentContainerStyle={{marginTop:Spacing.SCALE_15,paddingHorizontal:Spacing.SCALE_10}}
        ...
        renderItem={({item,index}) => {
          return(
            <TouchableOpacity style={{
              ...
              onPress={() => item?.nav ==='MyAddress' ? navigation.navigate(item?.nav) : Alert.alert('Feature coming soon')}
            >
                <View
                style={{
                  borderWidth:1,
               ...
               <Icon
                name={item.icon}
                size={FontSize.FONT_SIZE_22}
              />
              </View>
              <Text style={{flex:1,fontSize:FontSize.FONT_SIZE_15}}>{item?.name}</Text>
              <Icon
       ...
       <TouchableOpacity 
        ...
        >
           <Text style={{color:'white',fontSize:FontSize.FONT_SIZE_15}}>Log Out</Text>
         </TouchableOpacity>
         <TouchableOpacity style={{...styles.btnStyle1,backgroundColor:'black'}} >
           <Icon
            name='ios-share-social'
            size={FontSize.FONT_SIZE_16}
            color={'white'}
           />
           <Text style={{color:'white',marginLeft:Spacing.SCALE_5,fontSize:FontSize.FONT_SIZE_15}}>Share app</Text>
         </TouchableOpacity>
    </View>
  )
}
